...
<body class="">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <form id="receiptOrdersLab-form" class="smart-form" autocomplete="off">
                                        ...
                                        <c:if test="${not empty tomaMx.idNotificacion.solicitante}">
                                        <div class="row">
                                            <section class="col col-sm-6 col-md-6 col-lg-6">
                                                ...
                                                <div class="">
                                                    <label class="input">
                                                        <i class="icon-prepend fa fa-pencil fa-fw"></i><i class="icon-append fa fa-sort-alpha-asc fa-fw"></i>
                                                        <input class="form-control" type="text" id="nombre" name="nombre" disabled value="${tomaMx.idNotificacion.solicitante.nombre}" placeholder=" <spring:message code="lbl.applicant.name" />">
                                            ...
                                            <section class="col col-sm-6 col-md-6 col-lg-6">
                                                ...
                                                <div class="">
                                                    <label class="input">
                                                        <i class="icon-prepend fa fa-pencil fa-fw"></i><i class="icon-append fa fa-sort-alpha-asc fa-fw"></i>
                                                        <input class="form-control" type="text" name="contacto" id="contacto" disabled value="${tomaMx.idNotificacion.solicitante.nombreContacto}" placeholder=" <spring:message code="lbl.contact.name" />" />
                                                        <b class="tooltip tooltip-bottom-right"> <i
                                            ...
                                            <div class="row">
                                                <section class="col col-sm-12 col-md-4 col-lg-3">
                                                    ...
                                                    <div class="">
                                                        <label class="input">
                                                            <i class="icon-prepend fa fa-pencil fa-fw"></i><i class="icon-append fa fa-sort-alpha-asc fa-fw"></i>
                                                            <input class="form-control" type="text" disabled id="codSilais" name="codSilais" value="${tomaMx.idNotificacion.nombreSilaisAtencion}" placeholder=" <spring:message code="lbl.silais" />">
                                                ...
                                                <section class="col col-sm-12 col-md-8 col-lg-6">
                                                    ...
                                                    <div class="">
                                                        <label class="input">
                                                            <i class="icon-prepend fa fa-pencil fa-fw"></i><i class="icon-append fa fa-sort-alpha-asc fa-fw"></i>
                                                            <input class="form-control" type="text" disabled id="codUnidadSalud" name="codUnidadSalud" value="${tomaMx.idNotificacion.nombreUnidadAtencion}" placeholder=" <spring:message code="lbl.health.unit" />">
                                                ...
                                                <div class="widget-body no-padding">
                                                    <table id="solicitudes_list" class="table table-striped table-bordered table-hover" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th data-hide="phone"><spring:message code="lbl.final.result"/></th>
                                                            <th data-hide="phone"><spring:message code="lbl.results.approved"/></th>
                                                ...
                                                <div class="widget-body no-padding">
                                                    <table id="examenes_list" class="table table-striped table-bordered table-hover" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th data-hide="phone"><spring:message code="lbl.result"/></th>
    ...
    <spring:url value="/resources/scripts/laboratorio/editarSolicitudesMx/proccess.js" var="editMxJs" />
    ...
    <script type="text/javascript">
		$(document).ready(function() {
			...
			var parametros = {sPersonUrl: "${sPersonUrl}",
                ...
                sgetOrdenesExamenUrl : "${sgetOrdenesExamenUrl}",sAnularExamenUrl : "${sAnularExamenUrl}",
                sDxURL : "${sDxURL}",
