...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li><a href="<spring:url value="/" htmlEscape="true "/>"><spring:message code="menu.home" /></a> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/administracion/sampleTypes/init" htmlEscape="true "/>"><spring:message code="lbl.sample.types" /></a></li>
    </ol>
    <!-- end breadcrumb -->
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            ...
            <spring:message code="lbl.sample.types" />
                    ...
                    <div class="modal-header">
                        <div class="alert alert-info">
                            ...
                            <h4 class="modal-title">
                                <i class="fa-fw fa fa-list-ul"></i>
                                <spring:message code="lbl.add.edit.sample.type"/>
                            </h4>
                        </div>
                    </div>

                    <div class="modal-body">
                        <form id="sample-type-form" class="smart-form" autocomplete="off">
                            <div class="row">
                                <input id="idTipoMx" hidden="hidden" type="text" name="idTipoMx"/>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var parametros = {blockMess: "${blockMess}",
            sampleTypesUrl : "${getSampleTypes}",
            addUpdateUrl: "${addUpdateUrl}"


        };
        SampleTypes.init(parametros);
