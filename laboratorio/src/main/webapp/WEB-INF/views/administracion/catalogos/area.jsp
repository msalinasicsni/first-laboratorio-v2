...
<div id="main" data-role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<spring:url value="/" htmlEscape="true "/>"> <spring:message code="menu.home" /></a> <i class="fa fa-angle-right"></i> <spring:message code="menu.catalogs" /> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/administracion/area/list" htmlEscape="true "/>"><spring:message code="menu.area" /></a></li>
        </ol>
        <!-- end breadcrumb -->
                ...
                <h1 class="page-title txt-color-blueDark">
                    ...
                    <spring:message code="lbl.area" />
						<span> <i class="fa fa-angle-right"></i>
							<spring:message code="lbl.area.list" />
						</span>
                </h1>
            </div>
            <!-- end col -->
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <input id="msgSave" type="hidden" value="<spring:message code="msg.save.area"/>"/>
                                <input id="msgOverride" type="hidden" value="<spring:message code="msg.override.area"/>"/>
                                ...
                                <table class="table table-striped table-bordered table-hover" width="100%" id="area-list">
                                    <thead>
                                    <tr>
                    ...
                    <div class="modal-header">
                        <div class="alert alert-info">
                            ...
                            <h4 class="modal-title">
                                <i class="fa-fw fa fa-sitemap"></i>
                                <spring:message code="lbl.header.modal.area" />
                            </h4>
                        </div>
                    </div>
                    <div class="modal-body"> <!--  no-padding -->
                        <div class="row">
                            <div class="col col-sm-12 col-md-12 col-lg-12">
                                <form id="area-form" class="smart-form" novalidate="novalidate">
                                    <div class="row">
                                        <section class="col col-sm-12 col-md-8 col-lg-8">
                                            ...
                                            <div class="">
                                                <label class="input">
                                                    ...
                                                    <input class="form-control" type="text" id="nombre"  name="nombre" value="" placeholder=" <spring:message code="lbl.area" />">
                                                    <b class="tooltip tooltip-bottom-right"> <i
                                                            class="fa fa-warning txt-color-pink"></i> <spring:message code="tooltip.area.name"/>
                                                    </b>
                                                </label>
                                            </div>
                                        </section>
...
<spring:url value="/resources/scripts/administracion/catalogos/areas.js" var="areaJs" />
<script src="${areaJs}"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<c:url var="saveUrl" value="/administracion/area/save"/>
<c:url var="areasUrl" value="/administracion/area/getAreas"/>
<c:url var="overrideUrl" value="/administracion/area/override"/>
<c:url var="areaUrl" value="/administracion/area/getArea"/>
