...
<div id="main" data-role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<spring:url value="/" htmlEscape="true "/>"><spring:message code="menu.home" /></a> <i class="fa fa-angle-right"></i> <spring:message code="menu.catalogs" /> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/administracion/direccion/list" htmlEscape="true "/>"><spring:message code="menu.catalog.management" /></a></li>
        </ol>
        <!-- end breadcrumb -->
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark">
                    ...
                    <spring:message code="lbl.managements" />
						<span> <i class="fa fa-angle-right"></i>
							<spring:message code="lbl.management.list" />
						</span>
                </h1>
            </div>
            <!-- end col -->
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <table class="table table-striped table-bordered table-hover" width="100%" id="management-list">
                                    <thead>
                                    <tr>
                    ...
                    <div class="modal-header">
                        <div class="alert alert-info">
                            ...
                            <h4 class="modal-title">
                                <i class="fa-fw fa fa-sitemap"></i>
                                <spring:message code="lbl.header.modal.management" />
                            </h4>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <section class="col col-sm-12 col-md-8 col-lg-8">
                                            <label class="text-left txt-color-blue font-md">
                                                <i class="fa fa-fw fa-asterisk txt-color-red font-sm"></i><spring:message code="lbl.management" />
                                            </label>
                                            <div class="">
                                                <label class="input">
                                                    <i class="icon-prepend fa fa-pencil fa-fw"></i><i class="icon-append fa fa-sort-alpha-asc fa-fw"></i>
                                                    <input class="form-control" type="text" id="nombre"  name="nombre" value="" placeholder=" <spring:message code="lbl.direction" />">
                                                    <b class="tooltip tooltip-bottom-right"> <i
                                                            class="fa fa-warning txt-color-pink"></i> <spring:message code="tooltip.management.name"/>
                                                    </b>
                                                </label>
                                            </div>
                                        </section>
...
<spring:url value="/resources/scripts/administracion/catalogos/management.js" var="managementJs" />
<script src="${managementJs}"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<c:url var="saveUrl" value="/administracion/direccion/save"/>
<c:url var="direccionesUrl" value="/administracion/direccion/getManagements"/>
<c:url var="overrideUrl" value="/administracion/direccion/override"/>
<c:url var="direccionUrl" value="/administracion/direccion/getManagement"/>
