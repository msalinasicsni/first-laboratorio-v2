...
<body class="">
	...
	<div id="main" data-role="main">
		...
		<div id="ribbon">
			...
			<!-- breadcrumb -->
			<ol class="breadcrumb">
				<li><a href="<spring:url value="/" htmlEscape="true "/>"><spring:message code="menu.home" /></a> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/recepcionMx/initCC" htmlEscape="true "/>"><spring:message code="lbl.check-in.samples.from.cc" /></a></li>
			</ol>
			<!-- end breadcrumb -->
				...
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark">
						...
						<i class="fa-fw fa fa-eyedropper"></i>
							<spring:message code="lbl.check-in.samples.from.cc" />
						<span> <i class="fa fa-angle-right"></i>  
							<spring:message code="act.receipt" />
						</span>
					</h1>
				</div>
				<!-- end col -->
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <input id="esCC" type="hidden" value="true" />
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <section class="col col-sm-6 col-md-6 col-lg-5">
                                                    <label class="text-left txt-color-blue font-md">
                                                        <spring:message code="lbl.full.origin.lab" /> </label>
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i class="fa fa-location-arrow fa-fw"></i></span>
                                                        <select id="codLaboratorio" name="codLaboratorio"
                                                                class="select2">
                                                            <option value=""><spring:message code="lbl.select" />...</option>
                                ...
                                <div class="widget-body no-padding">
                                    <table id="orders_result" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th data-hide="phone"><spring:message code="lbl.solic.short"/></th>
