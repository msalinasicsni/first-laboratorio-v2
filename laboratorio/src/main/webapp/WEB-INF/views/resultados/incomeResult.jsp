                                                        ...
                                                        <label class="input">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${not empty ordenExamen.solicitudDx}">
                                                                    <input class="form-control" type="text" disabled id="TipoNoti" name="TipoNoti" value="${ordenExamen.solicitudDx.idTomaMx.idNotificacion.codTipoNotificacion}" placeholder=" <spring:message code="lbl.sample.type" />">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input class="form-control" type="text" disabled id="TipoNoti" name="TipoNoti" value="${ordenExamen.solicitudEstudio.idTomaMx.idNotificacion.codTipoNotificacion}" placeholder=" <spring:message code="lbl.sample.type" />">
                                                                </c:otherwise>
                                                            </c:choose>
