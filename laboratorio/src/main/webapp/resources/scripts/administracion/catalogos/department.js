        ...
        init: function (parametros) {
            ...
            function loadDepartments(){
                $.getJSON(parametros.departamentosUrl, {
                    ...
                    table1.fnClearTable();
                    for (var i = 0; i < len; i++) {
                        var btnOverride = ' <button type="button" title="Anular" class="btn btn-default btn-xs btn-danger" data-id='+data[i].idDepartamento+' ' +
                            '> <i class="fa fa-times"></i>';
                        var btnEditar = ' <button type="button" title="Editar" class="btn btn-default btn-xs btn-primary" data-id='+data[i].idDepartamento+' ' +
                        ...
                        if (data[i].pasivo==true){
                            ...
                            btnOverride = ' <button type="button" title="Anular" disabled class="btn btn-default btn-xs btn-danger" data-id='+data[i].idDepartamento+' ' +
                                '> <i class="fa fa-times"></i>';
                        }
